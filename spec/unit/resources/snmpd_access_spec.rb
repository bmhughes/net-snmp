...
describe 'net_snmp_snmpd_config' do
  step_into :net_snmp_snmpd_access_user, :net_snmp_snmpd_access_basic, :net_snmp_snmpd_access_vacm
  platform 'centos'

  context 'Create net-snmp snmpd configuration file access statements' do
    recipe do
